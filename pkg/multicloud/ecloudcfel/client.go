...
const (
	CLOUD_PROVIDER_ECLOUD    = "EcloudCfel"
	CLOUD_PROVIDER_ECLOUD_CN = "移动云-cfel"
	CLOUD_PROVIDER_ECLOUD_EN = "EcloudCfel"
...
func (ec *SEcloudClient) doPost(r IRequest) (jsonutils.JSONObject, error) {
	r.SetMethod("POST")
