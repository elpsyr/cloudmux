...
require (
	...
	yunion.io/x/onecloud v0.3.10-0-alpha2
...
require (
	...
	yunion.io/x/sqlchemy v1.1.3-0.20240309151155-b34f29f02c79 // indirect
)

replace yunion.io/x/onecloud v0.3.10-0-alpha2 => github.com/elpsyr/cloudpods v0.3.11-0-alpha.1
